const Images = ()=>{
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 512 512">
            ...
            <g>
                <path fill="#E8E8E8" d="M512,355.28v41.76c0,5.76-4.72,10.48-10.48,10.48H10.48C4.72,407.52,0,402.8,0,397.04v-41.76H512z" />
            ...
            <rect x="20.88" y="41.76" fill="#FF5F5F" width="470.24" height="292.56" />
            <g>
                <path fill="#FFFFFF" d="M367.92,288H143.84c-10.16,0-18.4-8.24-18.4-18.4V107.04c0-10.16,8.24-18.4,18.4-18.4h224.08
                ...
                <polygon fill="#FFFFFF" points="225.44,142.64 304.56,188.32 225.44,234" />
            </g>
        </svg>
    )
